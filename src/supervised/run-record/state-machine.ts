...
const ALLOWED_TRANSITIONS: Record<RunStatus, RunStatus[]> = {
  ...
  codex_completed: ['code_review_running', 'verification_running', 'validation_running', 'failed'],
  code_review_running: ['code_review_completed', 'review_remediation_running', 'failed'],
  review_remediation_running: ['review_remediation_completed', 'failed', 'timed_out'],
  review_remediation_completed: ['code_review_running', 'failed'],
  code_review_completed: ['verification_running', 'validation_running', 'failed'],
  verification_running: ['verification_completed', 'failed'],
  verification_completed: ['validation_running', 'handoff_running', 'failed'],
